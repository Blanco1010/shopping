...
import '../../controllers/delivery/delivery_orders_create_controller.dart';
import '../../models/order.dart';

class DeliveryOrderCreateScreen extends StatefulWidget {
  final Order order;
  const DeliveryOrderCreateScreen({Key? key, required this.order})
      : super(key: key);

  @override
  _DeliveryOrderCreateScreenState createState() =>
      _DeliveryOrderCreateScreenState();
}

class _DeliveryOrderCreateScreenState extends State<DeliveryOrderCreateScreen> {
  final DeliveryOrderCreateController _con = DeliveryOrderCreateController();
