class MercadoPagoInstallment {
  ...
  late int installmentRate;
  late int discountRate;
  late int reimbursementRate;
  late List<dynamic> labels;
  late List<dynamic> installmentRateCollector;
  late double minAllowedAmount;
  late double maxAllowedAmount;
  late String recommendedMessage;
  late double installmentAmount;
  late double totalAmount;
  late String paymentMethodOptionId;
