import 'package:shop_app/models/mercado_pago_card_holder.dart';
import 'package:shop_app/models/mercado_pago_payment_method.dart';
import 'package:shop_app/models/mercado_pago_security_code.dart';
...
class MercadoPagoCreditCard {
  ...
  MercadoPagoPaymentMethod? paymentMethod = MercadoPagoPaymentMethod(id: '');
  ...
  late List<MercadoPagoCreditCard> creditCardList = [];
